...
class D5PreparationTests(unittest.TestCase):
    ...
    def test_multi_action_candidate_gate_and_no_oracle(self):
        c={"decision":"escalate","trigger":"policy_lapsed","escalate_to":"human claims assessor","reason":"model conclusion","evidence_trail":[{"source":"tools"}],"line_dispositions":[],"approved_total":0,"refused_total":0,"claim_total":2480,"date_of_service":"2026-09-02","policy_evidence":{"policy_id":"POL-X","status":"lapsed","start_date":"2025-01-01","end_date":"2025-12-31","annual_limit":1,"used_to_date":0,"remaining":1},"duplicate_assessment":[]}
