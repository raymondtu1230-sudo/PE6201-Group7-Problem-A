#!/usr/bin/env python3
"""Run the 14-case deterministic D3 checklist (not the D4 evaluation set)."""
...
def record(decision="approve_in_principle", trigger=None):
    value = {"decision": decision, "reason": "checklist evidence", "evidence_trail": []}
